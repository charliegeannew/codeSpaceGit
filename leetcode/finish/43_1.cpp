        ...
        for(int i=len1-1;i>=0;i--){
            for(int j=len2-1;j>=0;j--){
                ...
                if(len-1<(len1-1-i)+(len2-1-j)){
                    ...
                    int numI=(index1*index2+over)%10;
                    over=(int)((index1*index2+over)/10);
                    res=to_string(numI)+res;
                }
                else{
                    cout<<"2222222222222222"<<endl;
                    int numI=(index1*index2+over+(res[len-1-(len1-1-i+len2-1-j)]-'0'))%10;
                    over=(int)((index1*index2+over+(res[len-1-(len1-1-i+len2-1-j)]-'0'))/10);
